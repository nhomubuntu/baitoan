# Quy tắc ứng xử cộng tác viên

## Cam kết của chúng tôi

Với sự quan tâm của việc thúc đẩy một môi trường cởi mở và chào đón, chúng tôi là những người đóng góp và người bảo trì cam kết tham gia vào dự án của chúng tôi và cộng đồng của chúng tôi một trải nghiệm quấy rối cho mọi người, bất kể tuổi tác, kích thước cơ thể, khuyết tật, sắc tộc, Mức độ kinh nghiệm, quốc tịch, ngoại hình cá nhân, chủng tộc, tôn giáo, hoặc bản sắc và định hướng tình dục.
...
Người bảo trì dự án có quyền và trách nhiệm xóa, chỉnh sửa, hoặc từ chối nhận xét, cam kết, mã, chỉnh sửa wiki, các vấn đề và các khoản đóng góp khác không phù hợp với Quy tắc Ứng xử này hoặc cấm tạm thời hoặc vĩnh viễn bất kỳ đóng góp nào cho các hành vi khác Họ coi là không phù hợp, đe dọa, gây khó chịu hoặc có hại.

## Phạm vi

Quy tắc ứng xử này được áp dụng trong cả không gian dự án và trong không gian công cộng khi một cá nhân đại diện cho dự án hoặc cộng đồng của mình. Ví dụ về đại diện cho một dự án hoặc cộng đồng bao gồm việc sử dụng địa chỉ e-mail chính thức của dự án, đăng thông qua tài khoản truyền thông xã hội chính thức hoặc làm đại diện được chỉ định tại một sự kiện trực tuyến hoặc ngoại tuyến. Đại diện của một dự án có thể được các nhà duy trì dự án xác định và làm rõ thêm.

## Thực thi

Các trường hợp hành vi lạm dụng, quấy rối hoặc không thể chấp nhận khác có thể được báo cáo bằng cách liên hệ với nhóm dự án tại duongthanhdung101095@gmail.com. Nhóm dự án sẽ xem xét và điều tra tất cả các khiếu nại, và sẽ trả lời theo cách mà nó cho là phù hợp với hoàn cảnh. Nhóm dự án có nghĩa vụ duy trì tính bảo mật đối với phóng viên của một sự cố. Các chi tiết khác về chính sách thực thi cụ thể có thể được đăng riêng.
...
Quy tắc ứng xử này được điều chỉnh từ [Cộng tác viên] [trang chủ], phiên bản 1.4, có tại [http://contributor-covenant.org/version/1/4]Phiên bản]
